...
public abstract class MixinBaseFluid {
    @Shadow protected abstract FluidState getUpdatedState(ViewableWorld viewableWorld_1, BlockPos blockPos_1, BlockState blockState_1);

    @Shadow protected abstract int getNextTickDelay(World world_1, BlockPos blockPos_1, FluidState fluidState_1, FluidState fluidState_2);

    @Shadow protected abstract void method_15725(IWorld iWorld_1, BlockPos blockPos_1, FluidState fluidState_1);
    ...
    public void onScheduledTick(World world_1, BlockPos blockPos_1, FluidState fluidState_1) {
        ...
        if(state!=null) {
            ...
            if (s.isAir() || s.getBlock().getStateFactory().getProperty("fluidlogged") == null) {
